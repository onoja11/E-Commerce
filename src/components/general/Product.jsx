...
const Product = ({ id, name, description, route, preview, actionButtons, addToCartBtn ,category, pic, price, border, stock, textColor = 'text-white', onDelete, onEdit }) => {
    ...
    <div className={`${border} stagger-animation cursor-pointer glass-effect rounded-2xl overflow-hidden group`}>
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button 
            onClick={() => addToCart({ id, name, price, image: pic,quantity: 1, stock })} 
            className={`flex ${addToCartBtn} items-center gap-2 px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded-lg text-white text-sm transition-colors duration-200`}
          >
