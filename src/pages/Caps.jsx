...
const Caps = () => {
  ...
  return (
    ...
    <Hero heading={'Premium Collection'} description={'                Discover our premium collection of stylish caps, crafted for the modern individual'} />
     <a href="#collection" class="inline-flex  items-center px-8 py-4 bg-gradient-to-r from-gray-600 to-gray-600 rounded-full text-white font-semibold hover:from-gray-700 hover:to-gray-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl test" >
                Explore Collection
